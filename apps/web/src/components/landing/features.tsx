...
const features = [
  ...
  { icon: MessagesSquare, title: 'Chat intern', description: 'Canale, mesaje, reacții și fișiere — comunicare rapidă fără să ieși din platformă.' },
        ...
        <div className="mt-16 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group bg-card p-6 transition-colors hover:bg-accent/50"
            >
