...
async function bootstrap() {
  // `rawBody: true` — necesar STRICT pentru verificarea semnăturii
  // webhook-ului Stripe (`BillingController.webhook`), care are nevoie de
  // bytes-ii bruți ai body-ului, nu JSON-ul parsat. Nest atașează bufferul
  // brut pe `req.rawBody` pentru toate cererile, fără să schimbe parsarea
  // normală JSON pentru restul rutelor.
